class TraderUI extends UIScriptedMenu
{
	...
	{
        layoutRoot = GetGame().GetWorkspace().CreateWidgets( "BastionMod/BastionVendor/GUI/Layout/TraderUI.layout" );
    ...
    */
    ...
    {  
        ...
        TraderVendorSettings traderSettings = GetClientSettings().GetPlayer();
        if (traderSettings)
        {
