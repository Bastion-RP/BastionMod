...
class CfgVehicles
{
	...
	class BRP_Dosimeter: Inventory_Base
	{
		...
		model = "BastionMod\BastionDangerousZone\data\dosimeter\geiger.p3d";
		rotationFlags = 2;
		weight = 500;
		absorbency = 0.0;
		itemSize[] = {3,2};
		...
		hiddenSelectionsTextures[]=
		{
			"BastionMod\BastionDangerousZone\data\dosimeter\data\geiger_ca.paa"
		};
		class EnergyManager
		{
			hasIcon=1;
		...
		class DamageSystem
		{
			class GlobalHealth
			{
				class Health
				{
					...
					healthLevels[] =
					{
						{1.0,{"BastionMod\BastionDangerousZone\data\dosimeter\data\geiger.rvmat"}},
						{0.7,{"BastionMod\BastionDangerousZone\data\dosimeter\data\geiger.rvmat"}},
						{0.5,{"BastionMod\BastionDangerousZone\data\dosimeter\data\geiger_damage.rvmat"}},
						{0.3,{"BastionMod\BastionDangerousZone\data\dosimeter\data\geiger_damage.rvmat"}},
						{0.0,{"BastionMod\BastionDangerousZone\data\dosimeter\data\geiger_destruct.rvmat"}}
					};
				};
			};
		};
