...
class CfgVehicles
{
	...
	class BRP_VendorBase: HouseNoDestruct
	{
		scope = 0;
	...
	class BRP_AionVendor: BRP_VendorBase
	{
		scope = 1;
		hiddenSelectionsTextures[] = 
		{
	...
	class BRP_MedicalVendor1: BRP_VendorBase
	{
		scope = 1;		
		hiddenSelectionsTextures[] = 
		{
	...
	class BRP_MedicalVendor1_Bloody: BRP_VendorBase
	{
		scope = 1;
		hiddenSelectionsTextures[] = 
		{
	...
	class BRP_MedicalVendor2: BRP_VendorBase
	{
		scope = 1;
		hiddenSelectionsTextures[] = 
		{
	...
	class BRP_MedicalVendor2_Bloody: BRP_VendorBase
	{
		scope = 1;
		hiddenSelectionsTextures[] = 
		{
	...
	class BRP_MedicalVendor3: BRP_VendorBase
	{
		scope = 1;
		hiddenSelectionsTextures[] = 
		{
	...
	class BRP_MedicalVendor4: BRP_VendorBase
	{
		scope = 1;
		hiddenSelectionsTextures[] = 
		{
