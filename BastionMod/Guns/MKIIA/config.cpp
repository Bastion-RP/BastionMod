////////////////////////////////////////////////////////////////////
//DeRap: P:\BastionMod\Guns\MKIIA\config.bin
//Produced from mikero's Dos Tools Dll version 7.60
//https://mikero.bytex.digital/Downloads
//'now' is Thu Mar 26 21:19:52 2020 : 'file' last modified on Thu Mar 26 21:19:52 2020
////////////////////////////////////////////////////////////////////
...
class cfgWeapons
{
	...
	class BastionRPGuns_MKIIA: MKIIA_Base
	{
		...
		model = "BastionMod\Guns\MKIIA\MKIIA.p3d";
		attachments[] = {};
		itemSize[] = {4,2};
		class DamageSystem
		{
...
class CfgMagazines
{
	...
	class Mag_MKIIA_6rnd: Mag_CZ75_15Rnd
	{
		...
		model = "BastionMod\Guns\MKIIA\mag_MKIIA_6rnd.p3d";
		weight = 40;
		itemSize[] = {1,2};
		count = 6;
		ammoItems[] = {"Ammo_9x19"};
