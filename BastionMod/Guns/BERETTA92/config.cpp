////////////////////////////////////////////////////////////////////
//DeRap: P:\BastionMod\Guns\BERETTA92\config.bin
//Produced from mikero's Dos Tools Dll version 7.60
//https://mikero.bytex.digital/Downloads
//'now' is Thu Mar 26 21:17:59 2020 : 'file' last modified on Thu Mar 26 21:17:59 2020
////////////////////////////////////////////////////////////////////
...
class cfgWeapons
{
	...
	class BastionRPGuns_BerettaM9: CZ75
	{
		...
		model = "BastionMod\Guns\BERETTA92\Beretta92.p3d";
		attachments[] = {};
		magazines[] = {"Mag_BerettaM9_15Rnd"};
		itemSize[] = {4,2};
		class DamageSystem
...
class CfgMagazines
{
	...
	class Mag_BerettaM9_15rnd: Mag_CZ75_15Rnd
	{
		...
		model = "BastionMod\Guns\BERETTA92\mag_Beretta92_15rnd.p3d";
		weight = 40;
		itemSize[] = {1,2};
		count = 15;
		ammoItems[] = {"Ammo_9x19"};
