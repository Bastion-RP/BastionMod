////////////////////////////////////////////////////////////////////
//DeRap: P:\BastionMod\Guns\BROWNINGHP\config.bin
//Produced from mikero's Dos Tools Dll version 7.60
//https://mikero.bytex.digital/Downloads
//'now' is Thu Mar 26 21:18:17 2020 : 'file' last modified on Thu Mar 26 21:18:17 2020
////////////////////////////////////////////////////////////////////
...
class cfgWeapons
{
	...
	class BastionRPGuns_BrowningHP: FNX45
	{
		...
		model = "BastionMod\Guns\BROWNINGHP\BrowningHP.p3d";
		attachments[] = {};
		magazines[] = {"Mag_BrowningHP_13Rnd"};
...
class CfgMagazines
{
	...
	class Mag_BrowningHP_13rnd: Mag_CZ75_15Rnd
	{
		...
		model = "BastionMod\Guns\BROWNINGHP\mag_BrowningHP_13rnd.p3d";
		weight = 40;
		itemSize[] = {1,2};
		count = 13;
		ammoItems[] = {"Ammo_9x19"};
