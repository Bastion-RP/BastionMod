class PaintTundraGreen extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Tundra Green";
		...
		//ingredient 2
		InsertIngredient(1,"Winchester70");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("Winchester70_Green");//add results here
	...
	{
		MiscGameplayFunctions.TurnItemIntoItemEx(player, new TurnItemIntoItemLambda(ingredients[1], "Winchester70_Green", player));
	}
};
