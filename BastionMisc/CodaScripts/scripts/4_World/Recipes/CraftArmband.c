class craftarmygreenarmband extends RecipeBase
{
	override void Init()
	{
		m_Name = "Craft Armband";
		...
		//result1
		AddResult("coda_armband_armygreen");//add results here
...
class craftbabybluearmband extends RecipeBase
{
	override void Init()
	{
		m_Name = "Craft Armband";
		...
		//result1
		AddResult("coda_armband_babyblue");//add results here
...
class craftbabypinkarmband extends RecipeBase
{
	override void Init()
	{
		m_Name = "Craft Armband";
		...
		//result1
		AddResult("coda_armband_babypink");//add results here
...
class craftbeigearmband extends RecipeBase
{
	override void Init()
	{
		m_Name = "Craft Armband";
		...
		//result1
		AddResult("coda_armband_beige");//add results here
...
class craftblackarmband extends RecipeBase
{
	override void Init()
	{
		m_Name = "Craft Armband";
		...
		//result1
		AddResult("coda_armband_black");//add results here
...
class craftburgundyarmband extends RecipeBase
{
	override void Init()
	{
		m_Name = "Craft Armband";
		...
		//result1
		AddResult("coda_armband_burgundy");//add results here
...
class craftcandypinkarmband extends RecipeBase
{
	override void Init()
	{
		m_Name = "Craft Armband";
		...
		//result1
		AddResult("coda_armband_candypink");//add results here
...
class craftcreamarmband extends RecipeBase
{
	override void Init()
	{
		m_Name = "Craft Armband";
		...
		//result1
		AddResult("coda_armband_cream");//add results here
...
class craftcyanarmband extends RecipeBase
{
	override void Init()
	{
		m_Name = "Craft Armband";
		...
		//result1
		AddResult("coda_armband_cyan");//add results here
...
class craftdarkbrownarmband extends RecipeBase
{
	override void Init()
	{
		m_Name = "Craft Armband";
		...
		//result1
		AddResult("coda_armband_darkbrown");//add results here
...
class craftdarkgreyarmband extends RecipeBase
{
	override void Init()
	{
		m_Name = "Craft Armband";
		...
		//result1
		AddResult("coda_armband_darkgrey");//add results here
...
class craftfuchsiaarmband extends RecipeBase
{
	override void Init()
	{
		m_Name = "Craft Armband";
		...
		//result1
		AddResult("coda_armband_fuchsia");//add results here
...
class craftlavenderarmband extends RecipeBase
{
	override void Init()
	{
		m_Name = "Craft Armband";
		...
		//result1
		AddResult("coda_armband_lavender");//add results here
...
class craftlightbrownarmband extends RecipeBase
{
	override void Init()
	{
		m_Name = "Craft Armband";
		...
		//result1
		AddResult("coda_armband_lightbrown");//add results here
...
class craftlightgreyarmband extends RecipeBase
{
	override void Init()
	{
		m_Name = "Craft Armband";
		...
		//result1
		AddResult("coda_armband_lightgrey");//add results here
...
class craftnavybluearmband extends RecipeBase
{
	override void Init()
	{
		m_Name = "Craft Armband";
		...
		//result1
		AddResult("coda_armband_navyblue");//add results here
...
class craftolivegreenarmband extends RecipeBase
{
	override void Init()
	{
		m_Name = "Craft Armband";
		...
		//result1
		AddResult("coda_armband_olivegreen");//add results here
...
class craftorangearmband extends RecipeBase
{
	override void Init()
	{
		m_Name = "Craft Armband";
		...
		//result1
		AddResult("coda_armband_orange");//add results here
...
class craftplumarmband extends RecipeBase
{
	override void Init()
	{
		m_Name = "Craft Armband";
		...
		//result1
		AddResult("coda_armband_plum");//add results here
...
class craftpurplearmband extends RecipeBase
{
	override void Init()
	{
		m_Name = "Craft Armband";
		...
		//result1
		AddResult("coda_armband_purple");//add results here
...
class craftredarmband extends RecipeBase
{
	override void Init()
	{
		m_Name = "Craft Armband";
		...
		//result1
		AddResult("coda_armband_red");//add results here
...
class craftroyalbluearmband extends RecipeBase
{
	override void Init()
	{
		m_Name = "Craft Armband";
		...
		//result1
		AddResult("coda_armband_royalblue");//add results here
...
class craftwhitearmband extends RecipeBase
{
	override void Init()
	{
		m_Name = "Craft Armband";
		...
		//result1
		AddResult("coda_armband_white");//add results here
...
class craftyellowarmband extends RecipeBase
{
	override void Init()
	{
		m_Name = "Craft Armband";
		...
		//result1
		AddResult("coda_armband_yellow");//add results here
