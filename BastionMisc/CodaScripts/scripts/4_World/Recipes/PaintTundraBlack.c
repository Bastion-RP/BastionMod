class PaintTundraBlack extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Paint Tundra Black";
		...
		//result1
		AddResult("Winchester70_Black");//add results here
	...
	{
		MiscGameplayFunctions.TurnItemIntoItemEx(player, new TurnItemIntoItemLambda(ingredients[1], "Winchester70_Black", player));
	}
};
