...
class CfgVehicles
{
	...
	class wall_barricade1_4: HouseNoDestruct
	{
		scope = 2;
		model = "\DZ\structures_bliss\walls\wall_barricade1_4.p3d";
	};
	class wall_barricade1_10: HouseNoDestruct
	{
		scope = 2;
