////////////////////////////////////////////////////////////////////
//DeRap: P:\BastionMod\BastionGuns\AR15_SBR\config.bin
//Produced from mikero's Dos Tools Dll version 7.60
//https://mikero.bytex.digital/Downloads
//'now' is Tue Apr 28 20:40:10 2020 : 'file' last modified on Tue Apr 28 20:40:10 2020
////////////////////////////////////////////////////////////////////
...
class CfgPatches
{
	class AR15
	{
		...
		weapons[] = {"BastionRPGuns_ar15_sbr"};
	};
};
class Mode_Safe;
class Mode_SemiAuto;
...
class cfgWeapons
{
	...
	class BastionRPGuns_ar15_sbr: ar15_Base
	{
		scope = 2;
		...
		model = "BastionMod\BastionGuns\AR15_SBR\ar15_sbr.p3d";
		attachments[] = {"weaponMuzzleM4","weaponFlashlight","weaponButtstockM4","weaponOptics","weaponHandguardM4"};
		itemSize[] = {8,3};
		dexterity = 2.8;
		class Particles
		{
