////////////////////////////////////////////////////////////////////
//DeRap: P:\BastionMod\BastionMisc_Data\Phone\config.bin
...
class CfgMods
{
	class BRP_DyerPhoneV2
	{
		...
		class defs
		{
			...
			{
				value = "";
				files[] = {"BastionMod/Phone/scripts/4_World"}; //need to change
			};
		};
	};
};
class CfgVehicles
{
	...
	class BRP_DyerPhoneV2: Inventory_Base
	{
		...
		model = "\BastionMod\BastionMisc_Data\Phone\Bastion_Phone.p3d";
		weight = 250;
		itemSize[] = {1,2};
		itemBehaviour = 1;
		rotationFlags = 1;
		...
		hiddenSelectionsTextures[] = {"BastionMod\BastionMisc_Data\Phone\data\bastionphone_co.paa"};
	};
};
class CfgSlots
{
