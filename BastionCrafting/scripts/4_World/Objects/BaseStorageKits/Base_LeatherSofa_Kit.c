class Base_LeatherSofa_Kit extends ItemBase
{	
	ref protected EffectSound 						m_DeployLoopSound;
	protected Object								Base_LeatherSofa_Kit1;
	
	void Base_LeatherSofa_Kit()
	{
...
class Base_LeatherSofa_Holo extends ItemBase
{
...
class Base_LeatherSofa extends ItemBase
{
		override bool CanPutInCargo( EntityAI parent )
    {
        if( !super.CanPutInCargo(parent) ) {return false;}        
