class Base_Nightstand_Kit extends ItemBase
{	
	ref protected EffectSound 						m_DeployLoopSound;
	protected Object								Base_Nightstand_Kit1;
...
class Base_Nightstand_Holo extends ItemBase
{
...
class Base_Nightstand extends ItemBase
{
		override bool CanPutInCargo( EntityAI parent )
    {
        if( !super.CanPutInCargo(parent) ) {return false;}        
