class Base_SingleBed_Kit extends ItemBase
{	
	ref protected EffectSound 						m_DeployLoopSound;
	protected Object								Base_SingleBed_Kit1;
	
	void Base_SingleBed_Kit()
	{
...
class Base_SingleBed_Holo extends ItemBase
{
...
class Base_SingleBed extends ItemBase
{
		override bool CanPutInCargo( EntityAI parent )
    {
        if( !super.CanPutInCargo(parent) ) {return false;}        
