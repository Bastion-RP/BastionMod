class Base_WoodStorage_Kit extends ItemBase
{	
	ref protected EffectSound 						m_DeployLoopSound;
	protected Object								Base_WoodStorage_Kit1;
...
class Base_WoodStorage_Holo extends ItemBase
{
...
class Base_WoodStorage extends ItemBase
{
		override bool CanPutInCargo( EntityAI parent )
    {
        if( !super.CanPutInCargo(parent) ) {return false;}        
