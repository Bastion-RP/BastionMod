class Base_Chernarus_Flag_Kit extends ItemBase
{	
	ref protected EffectSound 						m_DeployLoopSound;
	protected Object								Base_Chernarus_Flag_Kit1;
...
class Base_Chernarus_Flag_Holo extends ItemBase
{
...
class Base_Chernarus_Flag extends ItemBase
{
		override bool CanPutInCargo( EntityAI parent )
    {
        if( !super.CanPutInCargo(parent) ) {return false;}        
