class Base_Cot_Kit extends ItemBase
{	
	ref protected EffectSound 						m_DeployLoopSound;
	protected Object								Base_Cot_Kit1;
	...
	override void OnPlacementComplete( Man player )
	{
		...
		if ( GetGame().IsServer() )
		{
			...
			Base_Cot_Kit1 = GetGame().CreateObject("Base_Cot", pb.GetLocalProjectionPosition(), false );
			Base_Cot_Kit1.SetPosition( position );
			Base_Cot_Kit1.SetOrientation( orientation );
		}	
...
class Base_Cot_Holo extends ItemBase
{
...
class Base_Cot extends ItemBase
{
		override bool CanPutInCargo( EntityAI parent )
    {
        if( !super.CanPutInCargo(parent) ) {return false;}        
