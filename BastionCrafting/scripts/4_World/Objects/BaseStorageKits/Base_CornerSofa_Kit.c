class Base_CornerSofa_Kit extends ItemBase
{	
	ref protected EffectSound 						m_DeployLoopSound;
	protected Object								Base_CornerSofa_Kit1;
	
	void Base_CornerSofa_Kit()
	{
...
class Base_CornerSofa_Holo extends ItemBase
{
...
class Base_CornerSofa extends ItemBase
{
		override bool CanPutInCargo( EntityAI parent )
    {
        if( !super.CanPutInCargo(parent) ) {return false;}        
